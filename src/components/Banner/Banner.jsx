...
const Banner = () => {
  return (
    <div
      className="mt-6 max-w-7xl mx-auto flex justify-center items-center bg-center bg-cover bg-[#131313] rounded-xl"
    ...
    >
      <div className="py-[64px] text-center">
        ...
        <div className="border border-[#e7fe29] rounded-xl p-2 w-fit mx-auto mt-6">
          <button className="bg-[#e7fe29] py-2 px-4 rounded-xl text-[131313] font-bold">
            Claim Free Credit
          </button>
        </div>
      </div>
